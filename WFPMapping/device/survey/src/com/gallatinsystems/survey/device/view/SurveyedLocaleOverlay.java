...
import com.gallatinsystems.survey.device.activity.SurveyedLocaleMapActivity;
import com.gallatinsystems.survey.device.domain.SurveyedLocale;
import com.google.android.maps.GeoPoint;
import com.google.android.maps.MapView;

/**
 * Overlay class for displaying surveyed locale information
 * 
 * @author Christopher Fagiani, mark Westra
 * 
 */
public class SurveyedLocaleOverlay extends GeoOverlay {

	private SurveyedLocaleMapActivity slMapActivity;

	public SurveyedLocaleOverlay(SurveyedLocaleMapActivity slMapActivity) {
		super(false);
		this.slMapActivity = slMapActivity;
	}
	...
	public boolean onTap(GeoPoint point, final MapView mapView) {
		...
		if (matchingPointIndex > -1) {
			...
			SurveyedLocale slDetails = slMapActivity
